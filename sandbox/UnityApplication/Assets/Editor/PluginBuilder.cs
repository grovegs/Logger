...
namespace UnityApplication.Editor
{
    ...
    public static class PluginBuilder
    {
        ...
        {
            UnityEngine.Debug.Log("Building GroveGames.Logger.dll...");
            ...
            process.StartInfo.Arguments = "build ../../src/GroveGames.Logger/GroveGames.Logger.csproj -c Release -f netstandard2.1 -o ./Assets/Plugins";
