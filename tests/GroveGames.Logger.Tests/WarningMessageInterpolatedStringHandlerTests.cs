...
public class WarningMessageInterpolatedStringHandlerTests
{
    ...
    [Fact]
    public void Constructor_LoggerMinimumLevelWarning_CreatesHandler()
    {
        // Arrange
        var logger = new TestLogger(LogLevel.Warning);

        // Act
        var handler = new WarningMessageInterpolatedStringHandler(10, 2, logger);
    ...
    public void Constructor_LoggerMinimumLevelLowerThanWarning_CreatesHandler(LogLevel level)
    {
        // Arrange
    ...
    public void Constructor_LoggerLevelDebug_AllowsAppending()
    {
        ...
        var handler = new WarningMessageInterpolatedStringHandler(50, 2, logger);
        ...
        // Assert
        Assert.Equal("Warning: 999", handler.Written.ToString());
    }
    ...
    public void AppendLiteral_ValidString_AppendsToWritten()
    {
        // Arrange
        var logger = new TestLogger(LogLevel.Warning);
        var handler = new WarningMessageInterpolatedStringHandler(20, 0, logger);
    ...
    public void AppendMethods_MixedCalls_CombinesAllParts()
    {
        // Arrange
        var logger = new TestLogger(LogLevel.Warning);
        var handler = new WarningMessageInterpolatedStringHandler(30, 3, logger);
    ...
    public void AppendLiteral_EmptySpan_HandlesCorrectly()
    {
        // Arrange
        var logger = new TestLogger(LogLevel.Warning);
        var handler = new WarningMessageInterpolatedStringHandler(0, 0, logger);
    ...
    public void Constructor_NoLoggerLevelRestriction_AppendMethodsWork()
    {
        ...
        // Assert
        Assert.Equal("Warning: 404 - Not Found", handler.Written.ToString());
    }
    ...
    public void AppendMethods_MultipleFormats_AppliesEachCorrectly()
    {
        // Arrange
        var logger = new TestLogger(LogLevel.Warning);
        var handler = new WarningMessageInterpolatedStringHandler(100, 4, logger);
