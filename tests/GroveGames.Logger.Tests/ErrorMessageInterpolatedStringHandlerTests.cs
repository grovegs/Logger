...
public class ErrorMessageInterpolatedStringHandlerTests
{
    ...
    [Fact]
    public void Constructor_LoggerMinimumLevelError_CreatesHandler()
    {
        // Arrange
        var logger = new TestLogger(LogLevel.Error);

        // Act
        var handler = new ErrorMessageInterpolatedStringHandler(10, 2, logger);
    ...
    public void Constructor_LoggerMinimumLevelLowerThanError_CreatesHandler(LogLevel level)
    {
        // Arrange
    ...
    public void Constructor_LoggerLevelDebug_AllowsAppending()
    {
        ...
        var handler = new ErrorMessageInterpolatedStringHandler(50, 2, logger);
        ...
        // Assert
        Assert.Equal("Error: 999", handler.Written.ToString());
    }
    ...
    [Fact]
    public void Constructor_LoggerLevelWarning_AllowsAppending()
    {
        // Arrange
    ...
    [Fact]
    public void Constructor_LoggerLevelError_AllowsAppending()
    {
        // Arrange
        var logger = new TestLogger(LogLevel.Error);
        var handler = new ErrorMessageInterpolatedStringHandler(50, 2, logger);
    ...
    public void AppendLiteral_ValidString_AppendsToWritten()
    {
        // Arrange
        var logger = new TestLogger(LogLevel.Error);
        var handler = new ErrorMessageInterpolatedStringHandler(20, 0, logger);
    ...
    public void AppendMethods_MixedCalls_CombinesAllParts()
    {
        // Arrange
        var logger = new TestLogger(LogLevel.Error);
        var handler = new ErrorMessageInterpolatedStringHandler(30, 3, logger);
    ...
    public void AppendLiteral_EmptySpan_HandlesCorrectly()
    {
        // Arrange
        var logger = new TestLogger(LogLevel.Error);
        var handler = new ErrorMessageInterpolatedStringHandler(0, 0, logger);
    ...
    public void AppendFormatted_Double_FormatsCorrectly()
    {
        // Arrange
        var logger = new TestLogger(LogLevel.Error);
        var handler = new ErrorMessageInterpolatedStringHandler(30, 1, logger);
    ...
    public void Constructor_NoLoggerLevelRestriction_AppendMethodsWork()
    {
        ...
        // Assert
        Assert.Equal("Error: 404 - Not Found", handler.Written.ToString());
    }
    ...
    public void AppendMethods_MultipleFormats_AppliesEachCorrectly()
    {
        // Arrange
        var logger = new TestLogger(LogLevel.Error);
        var handler = new ErrorMessageInterpolatedStringHandler(100, 4, logger);
